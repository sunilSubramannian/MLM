      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-xs-12 mb-1">
            <h2 class="content-header-title">Products List</h2>
          </div>
          <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Product List</a>
                </li>
              </ol>
            </div>
          </div>
				                ...
				                <div class="table-responsive">
				                    <table class="table">
				                        ...
				                        <tbody>
				                            ...
				                            <tr>
				                                <th scope="row"><%= i+1 %></th>
				                                <td><%= productModel.get(i).getProductTag() %></td>
				                                <td>
				                                	<%
													...
													%>
				                                	<img alt="Product Image" src="data:image/jpg;base64,<%= encode %>" style="height: 120px; widows: 80px;">
				                                </td>
				                                <td><%= productModel.get(i).getProductName() %></td>
				                                <td><%= productModel.get(i).getCostPrice() %></td>
				                                <td><%= productModel.get(i).getSellingPrice() %></td>
				                                <td><%= productModel.get(i).getMFGDate() %></td>
				                                <td><%= productModel.get(i).getEXPDate()%></td>
				                                <td>
				                                	<button type="button" class="btn btn-warning btn-block">View Details</button>
				                                	<button type="button" class="btn btn-info btn-block">Edit Details</button>
